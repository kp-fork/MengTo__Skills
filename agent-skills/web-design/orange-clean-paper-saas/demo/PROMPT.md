...
Use $orange-clean-paper-saas to create a polished standalone HTML example that clearly demonstrates the skill.

## Recreate the demo

Use $orange-clean-paper-saas to build a responsive reference demo for this capability:
...
- Use Orange Clean Paper Saas as the central system title.
...
Use $orange-clean-paper-saas and keep the same implementation contract, but change the subject, copy, palette, and content hierarchy. Preserve the core technique, accessibility behavior, responsive rules, and performance constraints demonstrated by the reference.
