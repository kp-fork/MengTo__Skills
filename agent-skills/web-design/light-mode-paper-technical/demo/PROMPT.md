...
Use $light-mode-paper-technical to create a polished standalone HTML example that clearly demonstrates the skill.

## Recreate the demo

Use $light-mode-paper-technical to build a responsive reference demo for this capability:
...
- Use Light Mode Paper Technical as the central system title.
...
Use $light-mode-paper-technical and keep the same implementation contract, but change the subject, copy, palette, and content hierarchy. Preserve the core technique, accessibility behavior, responsive rules, and performance constraints demonstrated by the reference.
