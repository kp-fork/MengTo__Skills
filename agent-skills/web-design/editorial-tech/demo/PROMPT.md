...
Use $editorial-tech to create a polished standalone HTML example that clearly demonstrates the skill.

## Recreate the demo

Use $editorial-tech to build a responsive reference demo for this capability:
...
- Use Editorial Tech as the central system title.
...
Use $editorial-tech and keep the same implementation contract, but change the subject, copy, palette, and content hierarchy. Preserve the core technique, accessibility behavior, responsive rules, and performance constraints demonstrated by the reference.
