...
Use $company-logos to create a polished standalone HTML example that clearly demonstrates the skill.

## Recreate the demo

Use $company-logos to build a responsive reference demo for this capability:

> Use Iconify Simple Icons logos (64x64) instead of text logos.

### Direction

Demonstrate a seamless duplicated logo loop with a calm, readable speed.
...
Use $company-logos and keep the same implementation contract, but change the subject, copy, palette, and content hierarchy. Preserve the core technique, accessibility behavior, responsive rules, and performance constraints demonstrated by the reference.
